...
define('STR_RUBRIQUE_UTILISATEUR',		'Users');
define('STR_RUBRIQUE_EXEMPLE',       	'Examples');
define('STR_RUBRIQUE_DIVERS',        	'Miscellaneous');
define('STR_RUBRIQUE_FORMULAIRE',    	'Form');
define('STR_RUBRIQUE_SPECIAL',       	'Special');
define('STR_RUBRIQUE_EDITEUR',       	'Editor');
define('STR_RUBRIQUE_FILE',          	'File');
define('STR_RUBRIQUE_DECONNEXION',   	'Disconnect');
define('STR_RUBRIQUE_ACCUEIL',       	'Home');
define('STR_RUBRIQUE_PROFIL',        	'My profil');
define('STR_RUBRIQUE_CONNEXION',     	'Connect');
define('STR_RUBRIQUE_ONGLET',        	'Tab');
define('STR_RUBRIQUE_ONGLET_RETOUR', 	'Back');
define('STR_RUBRIQUE_ONGLET_COMPTE', 	'General Informations');
define('STR_RUBRIQUE_ONGLET_COULEUR',	'Colors');
define('STR_RUBRIQUE_ONGLET_THEME',  	'Theme');
define('STR_RUBRIQUE_PARAMETRE',        'Settings');
...
define('STR_BACKOFFICE_HELP_FILTRE',    '<li>Afin de filtrer les données suivant des critères pré-définis (<strong>%s</strong>), saisissez une occurence dans la zone de saisie et cliquez sur le bouton <strong>&laquo;OK&raquo;</strong> ou sélectionnez une des valeurs proposées.</li><li>Pour annuler l\'effet d\'un filtre, cliquer sur le bouton <strong>&laquo;Effacer&raquo;</strong> qui lui est éventuellement associé.</li><li>Pour voir à nouveau l\'ensemble des données retournées et annuler l\'effet de tous les filtres, cliquer sur le bouton <strong>&laquo;Reset&raquo;</strong></li>');
define('STR_BACKOFFICE_HELP_DATA',      'Cette zone présente l\'ensemble des données retournées:');
define('STR_BACKOFFICE_HELP_ORDER',     '<li>Cliquer sur l\'entête d\'une colonne (<strong>%s</strong>) pour ordonner les données par ordre croissant ou décroissant</li>');
define('STR_BACKOFFICE_HELP_ACTION',    '<li>Cliquer sur <strong>&laquo;%s&raquo;</strong> pour %s un élément</li>');
define('STR_BACKOFFICE_HELP_NAVIGATION','Par défaut, le flux de données retournées va s\'afficher à raison de <strong>%s</strong> éléments par page. Vous pouvez modifier ce nombre d\'élément en cliquant sur une des valeurs proposées sous le tableau, à gauche (<strong>Affichage par %s</strong>). Si le flux de données est trop important pour être affiché sur une seule page, vous pouvez avoir à naviguer page par page en utilisant les liens présents sous le tableau, au centre. Ils vous permettront d\'accéder aux différentes pages de résultat.<br/>');
...
define('STR_UTILISATEUR_LIBELLE_NOM', 'Lastname');
define('STR_UTILISATEUR_LIBELLE_PRENOM', 'Firstname');
define('STR_UTILISATEUR_LIBELLE_EMAIL', 'Email');
define('STR_UTILISATEUR_LIBELLE_PASSWORD', 'Password');
...
define('STR_UTILISATEUR_LIBELLE_LANGUE', 'Language');
define('STR_UTILISATEUR_LIBELLE_THEME', 'Theme');
...
define('STR_UTILISATEUR_FIELDSET_THEME', 'Change your theme and language');
define('STR_UTILISATEUR_LEGENDE_PASSWORD', 'Saisissez le mot de passe.');
define('STR_UTILISATEUR_LEGENDE_PASSWORD_MODIF', 'If you would like to change the password, type a new one twice. Otherwise leave this blank.');
define('STR_UTILISATEUR_LEGENDE_PASSWORD_CONFIRMATION', 'Type your new password again.');
...
define('STR_UTILISATEUR_E_WARNING_2', 'La modification a été effectuée !');
