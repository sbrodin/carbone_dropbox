...
switch (CFG_ENV) {
    ...
    case 'dev':
        ...
        define ('CFG_EMAIL_DROPBOX', 'stanislas.brodin@globalis-ms.com');   // Adresse email du compte Dropbox utilisé
        ...
        define ('CFG_PASS_UPLOAD_DROPBOX', 'toto');                         // Mot de passe pour l'upload versDropbox (demandé lors de l'envoi)
...
define ('CFG_DATE', '12/10/2013');                                          // Date de dernières révision de l'application
