 ...
 * -----
 * Export de données pdf ou excel
 ...
 * @param   array		$donnee                 tableau de données
 * @param   string      $legende                la légende
...
function export($format, $donnee, $legende, $couleur) {
    ...
    if($format == 'excel') {
        ...
        // La classe FPDF n'implémentant pas le support utf8, legende et données sont converties au format iso
        // La classe TCPDF devrait permettre de résoudre le problème
        //
