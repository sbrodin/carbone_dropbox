...
function debug_get_info($value) {
    ...
    elseif($value=='database') {
        ...
        if($foo=='')
            $foo=utf8_encode_mixed("Oops ! Pas de requête !");
        else
            $foo=implode('',$foo);
    }
                
    if($foo=="Array\n(\n)\n")
        $foo=utf8_encode_mixed("Oops ! Pas de donnée");
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse">
                            <ul class="nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-signal icon-white"></i> Mémoire '.debug_convert_memory(@memory_get_usage()).' <b class="caret"></b></a>
                                    <ul class="dropdown-menu">
